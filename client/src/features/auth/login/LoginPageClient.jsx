...
/**
 * LoginPageClient — client entry point for /login.
 *
...
import { useLogin, LOGIN_RULES } from "./useLogin";
...
// LoginHero — lazy chunk (has Next Image + heavy asset)
const LoginHero = dynamic(
  () => import("@/features/auth/ui/jsx/LoginHero"),
  {
    ssr: false,
